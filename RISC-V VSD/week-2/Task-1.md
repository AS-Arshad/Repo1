...
<summary> 1. Understanding SoC </summary>
   SoC (System on Chip) is a collections of digital modules performing various applications onto a simgle silicon chip
     Instead of needing separate modules for each function, an SoC incroporates every application module into one small package.
...
- In this we have understood the concept of SoC and how it incorporates the applications with examples
- we have understood the difference between SoC and BabySoC
- understood the concepts of BabySoC
- understood the components of BabySoC
